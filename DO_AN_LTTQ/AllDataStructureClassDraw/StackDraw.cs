...
{
    internal class StackDraw : DataStructureDraw
    {
<<<<<<< Updated upstream:DO_AN_LTTQ/AllDataStructureClass/Stack.cs
=======
        public StackDraw(string[] input_info)
        {

        }
>>>>>>> Stashed changes:DO_AN_LTTQ/AllDataStructureClassDraw/StackDraw.cs
